console.log("App version 7.0 starting...");
...
async function loadMatchups() {
    ...
    // Ensure standings are loaded so we can show records
    ...
    try {
        ...
        // Loop through the days in the current API schedule week
        data.gameWeek.forEach(function(day) {
            if (day.games.length > 0) {
                // Convert YYYY-MM-DD to a nicer format
                ...
                day.games.forEach(function(game) {
                    ...
                    // Auto-converts UTC puck drop to the user's local timezone
...
async function loadTeamData(teamName) {
    ...
    try {
        ...
        renderTable();
    } catch (e) { container.innerHTML = "<h1>Error loading team.</h1><button class='back-